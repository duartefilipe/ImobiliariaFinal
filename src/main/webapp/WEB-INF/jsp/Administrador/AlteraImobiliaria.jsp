...
<body>
		...
		<div class="col-md-9">
			<div class="container-fluid responsive" style="background-color: #504E4E; border-radius: 10px">
				<span style="color: #FFFFFF">
					<h2 align="center">Pagina principal do Administrador</h2></span>
					<hr>
					
						<form class="form-signin" action="AlterarImobiliaria" method="post">
						
							<input type="hidden" name="id" class="form-control" value="${imo.id }"><br>
							<h1>Alterar Imobiliaria</h1>
									
							<label for="nome">Nome</label><br>
							<input type="text" name="nome" class="form-control" value="${imo.nome }"><br>
							...
							<input type="text" name="telefone" class="form-control" value="${imo.telefone }"><br>
							
							<label for="cnpj">CNPJ</label><br>
							<input type="text" name="cnpj" class="form-control" value="${imo.cnpj }"><br>
							
							<label for="email">EMAIL</label><br>
							<input type="text" name="email" class="form-control" value="${imo.email }"><br>
							
							<label for="senha">Senha</label><br>
							<input type="text" name="senha" class="form-control" value="${imo.senha }"><br>
	...
	<div class="modal fade" id="modalimobiliaria" tabindex="-1" role="dialog" aria-labelledby="myModalImobiliaria">
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="border-radius: 10px">
				<div class="modal-header" style="background-color: #504E4E">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
