				...
				<span style="color: #FFFFFF">
					...
					<hr>
						...
						<form class="form-signin" action="#" method="post">
							...
							<input type="hidden" name="id" class="form-control" readonly="true" value="${imo.id }"><br>
									
							<label for="cidade">Cidade</label><br>
							<input type="text" name="cidade" class="form-control" readonly="true" value="${imo.cidade }"><br>
							
							<label for="endereco">Endereço</label><br>
							<input type="text" name="endereco" class="form-control" readonly="true" value="${imo.endereco }"><br>
							
							<label for="valor">Valor</label><br>
							<input type="text" name="valor" class="form-control" readonly="true" value="${imo.valor }"><br>
							
							<label for="caracteristicas">Caracteristicas</label><br>
							<input type="text" name="caracteristicas" class="form-control" readonly="true" value="${imo.caracteristicas }"><br>
