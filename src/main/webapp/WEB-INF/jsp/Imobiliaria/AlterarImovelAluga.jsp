				...
				<span style="color: #FFFFFF">
					...
					<hr>
						...
						<form class="form-signin" action="AlteraImovel" method="post">
							...
							<input type="hidden" name="id" class="form-control" value="${imoAl.id }"><br>
									
							<label for="cidade">Cidade</label><br>
							<input type="text" name="cidade" class="form-control" value="${imoAl.cidade }"><br>
							
							<label for="endereco">Endereço</label><br>
							<input type="text" name="endereco" class="form-control" value="${imoAl.endereco }"><br>
							
							<label for="valor">Valor</label><br>
							<input type="text" name="valor" class="form-control" value="${imoAl.valor }"><br>
							
							<label for="caracteristicas">Caracteristicas</label><br>
							<input type="text" name="caracteristicas" class="form-control" value="${imoAl.caracteristicas }"><br>
