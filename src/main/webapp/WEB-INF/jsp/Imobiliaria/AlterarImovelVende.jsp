...
<body>
		...
		<div class="col-md-9">
			<div class="container-fluid responsive" style="background-color: #504E4E; border-radius: 10px">
				<span style="color: #FFFFFF">
					<h2 align="center">Pagina principal da imobiliaria</h2>
				</span>
				<hr>
				...
				<form class="form-signin" action="AlteraImovel" method="post">
					...
					<input type="text" name="cidade" class="form-control"
						value="${imoV.cidade }"><br> <label for="endereco">Endereço</label><br>
					<input type="text" name="endereco" class="form-control"
						value="${imoV.endereco }"><br> <label for="valor">Valor</label><br>
					<input type="text" name="valor" class="form-control"
						value="${imoV.valor }"><br> <label
						for="caracteristicas">Caracteristicas</label><br> <input
						type="text" name="caracteristicas" class="form-control"
						value="${imoV.caracteristicas }"><br> <input
						type="hidden" name="tipo" value="vender">
	...
	<div class="modal fade" id="modalaluga" tabindex="-1" role="dialog"
		aria-labelledby="myModalAluga">
			...
			<div class="modal-content" style="border-radius: 10px">
				...
				<div class="modal-body">
					...
					<span style="color: #80BFFF">
						<h2 class="form-signin-heading">Cadastre um imóvel para
							alugar</h2>
					</span>

					<form class="form-signin" action="CadastrarImovel" method="post">

						<input type="hidden" name="opcao" value="inserir" /> <label
							for="cidade">Cidade</label><br> <input type="text"
							id="cidade" name="cidade" class="form-control"
							placeholder="Informe a cidade"><br> <label
							for="endereco">Endereço</label><br> <input type="text"
							id="endereco" name="endereco" class="form-control"
							placeholder="Informe o endereço"><br> <label
							for="valor">Valor</label><br> <input type="text" id="valor"
							name="valor" class="form-control" placeholder="Informe o valor"><br>

						<label for="caracteristicas">Caracteristicas</label><br> <input
							type="text" id="caracteristicas" name="caracteristicas"
							class="form-control" placeholder="Informe alguma caracteristica"><br>

						<input type="hidden" id="tipo" name="tipo" value="alugar">

						<label for="pro_foto">Imagem:</label> <input type="file"
							name="imagem" accept=".jpg, .png, .jpeg">
