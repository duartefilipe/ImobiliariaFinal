		...
		<div class="col-md-3">
			<div class="con">
				<div class="list-group">
					...
					</span></a> <a href="Locacao.jsp" class="list-group-item"> locaçao </a> <a
						href="Venda.jsp" class="list-group-item"> Venda </a> <a href="#"
							...
							<hr> <c:forEach var="aluga" items="${aluga}">
								<div class="col-sm-6 col-md-3">
									<a class="thumbnail" href="#"> <img
										src="http://www.plantasdecasas.com/wp-content/uploads/2012/11/Casa-de-Campo-Minas-Gerais-Cod.-400-590x300.jpg"
										alt="">
